/*
  ...
  brief:    Defines function prototypes for Exerñise 3 from Task 2
...
char* Monthes( unsigned short ); // returns the name of the month according to its number (income parameter)
