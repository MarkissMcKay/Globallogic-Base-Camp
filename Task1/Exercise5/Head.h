/*
  ...
  brief:    Defines function prototypes for Exerñise 5 from Task 1
...
signed short Function( signed long ); // returns some (signed long) number in case its positive and 0 otherwise
