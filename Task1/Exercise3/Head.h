/*
  ...
  brief:    Defines function prototypes for Exerñise 3 from Task 1
...
unsigned long Function( unsigned long , short , short );  // returns 1 in case two bits, entered from keyboard, in some (unsigned long int) digit are equal and 0 otherwise!
