/*
  ...
  brief:    Defines Interface - function prototypes for Exerñise 5 from Task 3
...
bool PresenceOfTheCombination( char* str, char* combination ); // returns true in case the symbol combination, selected by user, is present in the sentence, entered from keyboard  
